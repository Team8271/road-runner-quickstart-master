...
/**
 * prefered gamepad control for SOPHIA as driver 2
 */
@TeleOp(name = "SophiaTeleOp", group = "Comp")
//@Disabled
public class TonySophiaOpMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            **********************************************/
            ...
            {
                //open palm
                robot.palmL.setPosition(0.55); // center
    ...
    //region spin wrist
            if(gamepad2.left_stick_x > 0.5 && isUp)
            {
    ...
    //endregion
            ...
            telemetry.addData("RpodEnc", robot.rightEncoder.getCurrentPosition());
            telemetry.addData("LpodEnc", robot.leftEncoder.getCurrentPosition());
            telemetry.addData("BpodEnc", robot.backEncoder.getCurrentPosition());
